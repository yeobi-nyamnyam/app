...
export type TripMealLogsQuery = { meal_logsCollection: { edges: Array<{ node: { id: string, meal_slot_id: string | null, category: string, amount: number, store_name: string | null, store_address: string | null, memo: string | null, source: string, created_at: string, meal_slots: { date: string } | null } }> } };
