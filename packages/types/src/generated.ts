...
export type GoodPriceRestaurantsQuery = { restaurantsCollection: { edges: Array<{ node: { id: string, name: string, address: string, category: string | null, price_menus: unknown } }> } };
