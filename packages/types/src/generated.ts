...
export type MyPageDashboardQuery = { profilesByPk: { id: string, nickname: string, handle: string } | null, exp_ledgerCollection: { edges: Array<{ node: { points: number } }> }, user_badgesCollection: { edges: Array<{ node: { id: string } }> }, tripsCollection: { edges: Array<{ node: { id: string, status: string, meal_logsCollection: { edges: Array<{ node: { store_name: string | null } }> } | null } }> } };
