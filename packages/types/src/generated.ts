...
export type RestaurantByIdQuery = { restaurantsCollection: { edges: Array<{ node: { id: string, source: string, name: string, address: string, category: string | null, phone: string | null, price_menus: unknown } }> } };
...
export type TourApiRestaurantsQuery = { restaurantsCollection: { edges: Array<{ node: { id: string, name: string, category: string | null, latitude: number | null, longitude: number | null } }> } };
