...
export type CreateMealLogMutation = { insertIntomeal_logsCollection: { affectedCount: number, records: Array<{ id: string, trip_id: string, meal_slot_id: string | null, category: string, amount: number, store_name: string | null, store_address: string | null, memo: string | null, source: string, created_at: string }> } | null };
...
export type RecordMealLogMutation = { record_meal_log: { id: string, trip_id: string, meal_slot_id: string | null, category: string, amount: number, store_name: string | null, store_address: string | null, memo: string | null, source: string, created_at: string } | null };
...
export type TripMealLogsQuery = { meal_logsCollection: { edges: Array<{ node: { id: string, meal_slot_id: string | null, category: string, amount: number, store_name: string | null, store_address: string | null, memo: string | null, source: string, created_at: string } }> } };
...
export const UpdateMealLogDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateMealLog"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mealLogId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"amount"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeName"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeAddress"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"memo"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update_meal_log"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"p_meal_log_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mealLogId"}}},{"kind":"Argument","name":{"kind":"Name","value":"p_amount"},"value":{"kind":"Variable","name":{"kind":"Name","value":"amount"}}},{"kind":"Argument","name":{"kind":"Name","value":"p_store_name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeName"}}},{"kind":"Argument","name":{"kind":"Name","value":"p_store_address"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeAddress"}}},{"kind":"Argument","name":{"kind":"Name","value":"p_memo"},"value":{"kind":"Variable","name":{"kind":"Name","value":"memo"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"trip_id"}},{"kind":"Field","name":{"kind":"Name","value":"meal_slot_id"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"store_name"}},{"kind":"Field","name":{"kind":"Name","value":"store_address"}},{"kind":"Field","name":{"kind":"Name","value":"memo"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}}]}}]}}]} as unknown as DocumentNode<UpdateMealLogMutation, UpdateMealLogMutationVariables>;
